                ...
                <div className="flex flex-1 flex-col">
                    <div className="w-full flex items-center">
                        ...
                        {!isFirst && (
                            ...
                            >
                                <Icon
                                    name="create_thread_close_sub_thread_white"
                                    size={12}
                    ...
                    />
                    {thread.threadType === THREAD_TYPE.POLL && (
                        <CreatePoll options={thread.poll.options} threadId={thread.id} />
                    )}
                    <input
                        ...
                        onChange={e => {
                            handleSelectImages(
                                e.target.files
                                    ? [...Array.from(e.target.files)].map(file => ({ id: uuidv4(), file }))
                                    : []
                            )
                        }}
                        type="file"
                    ...
                    <div className="mt-1 w-full">
                        <div className="relative -left-2 flex w-full">
                            ...
                            >
                                ...
                                <Icon
                                    name="create_thread_modal_add_image_white"
                            ...
                            <div className="group relative grid size-9 cursor-pointer place-items-center duration-75 ease-linear active:scale-90">
                                ...
                                <Icon
                                    name="create_thread_modal_add_gif_white"
                                    className="hidden dark:block"
                                    size={20}
                                />
                            </div>
                            <div className="group relative grid size-9 cursor-pointer place-items-center duration-75 ease-linear active:scale-90">
                                ...
                                <Icon
                                    name="create_thread_modal_add_tag_white"
                                    className="hidden dark:block"
                                    size={24}
                                />
                            </div>
                            ...
                            >
                                ...
                                <Icon
                                    name="create_thread_modal_add_poll_white"
                                    className="hidden dark:block"
                                    size={24}
                                />
                            </div>
