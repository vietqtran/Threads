            ...
            <AnimatePresence>
                {isConfirm && (
                    ...
                    >
                        <div
                            ref={confirmRef}
                            className="w-full border rounded-2xl max-w-[250px] bg-content flex flex-col"
                        >
                            <div className="w-full text-center p-6 border-b">haha</div>
                            <div className="grid grid-cols-2">
                                <div
                                    onClick={closeModal}
                                    className="col-span-1 border-r p-4 cursor-pointer text-center"
                                >
                                    Yes
                                </div>
                                <div
                                    onClick={() => setIsConfirm(false)}
                                    className="col-span-1 p-4 cursor-pointer text-center"
                                >
                                    No
                                </div>
                            </div>
