    ...
    <div className="w-full">
      ...
      <div className="w-full p-4 pt-2">
        <div className="relative flex h-11 w-full rounded-xl bg-background">
          ...
          >
            <Icon
              name={theme === 'light' ? 'header_menu_appearance_sun_active_black' : 'header_menu_appearance_sun_black'}
              className="dark:hidden"
              size={18}
            />
            <Icon
              name={theme === 'light' ? 'header_menu_appearance_sun_active_white' : 'header_menu_appearance_sun_white'}
          ...
          >
            <Icon
              name={theme === 'dark' ? 'header_menu_appearance_moon_active_black' : 'header_menu_appearance_moon_black'}
              className="dark:hidden"
              size={18}
            />
            <Icon
              name={theme === 'dark' ? 'header_menu_appearance_moon_active_white' : 'header_menu_appearance_moon_white'}
              className="hidden dark:block"
              size={18}
            />
          </button>
