...
const NavLink = ({ icon, activeIcon, href, isActive, iconSize, activeIconSize }: Props) => {
  return (
    <li className='relative grid aspect-square h-15 w-15 cursor-pointer place-items-center rounded-lg duration-100 ease-linear before:absolute before:z-0 before:size-full before:scale-75 before:rounded-lg before:bg-black/5 before:opacity-0 before:duration-100 before:ease-linear before:content-[""] hover:before:scale-100 hover:before:opacity-100 active:scale-90 before:dark:bg-white/5'>
