  ...
  return (
    <div className="grid h-full w-full place-items-center rounded-xl bg-white p-10 sm:h-fit sm:w-[476px]">
      <div className="w-full max-w-[476px]">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold leading-6 text-gray-800">Login</h1>
          <span className="text-sm font-medium text-gray-600">Continue to EcomMERN</span>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-1 text-xs">
          <span>New to EcomMERN? </span>
          <Link href={'/register'} className="flex items-center gap-1 text-blue-500">
